...
<r:page titleId="title_action_pdf_split_at_page">
	...
	<f:view>
		...
		<h:form acceptcharset="UTF-8" id="pdf-split-action">
 ...
 %>
									<table cellpadding="2" cellspacing="2" border="0" width="100%">
										...
										<tr>
											<td><h:outputText value="#{customMsg.pdfsplit_at_page}:" /></td>
											<td><h:inputText
												value="#{WizardManager.bean.actionProperties.PDFSplitAtPage}"
